...
const FloatingContactButtons: React.FC = () => {
  ...
  return (
    <>
      {/* 桌面端右侧悬浮联系按钮组 */}
      <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50 flex flex-col space-y-4 floating-contact-buttons">
        {/* 电话按钮 */}
        <div className="relative group">
                         <button 
                 onClick={() => window.open('tel:+86-18326081058', '_self')}
                 className="bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110 group-hover:shadow-xl floating-contact-button"
                 title="Call Us"
               >
        ...
        <div className="relative group">
          <button 
            ...
            className="bg-green-400 text-white p-4 rounded-full shadow-lg hover:bg-green-500 transition-all duration-300 transform hover:scale-110 group-hover:shadow-xl floating-contact-button"
            title="WhatsApp"
          >
        ...
        <div className="relative group">
          <button 
            ...
            className="bg-red-500 text-white p-4 rounded-full shadow-lg hover:bg-red-600 transition-all duration-300 transform hover:scale-110 group-hover:shadow-xl floating-contact-button"
            title="Email Us"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative group">
          <button 
            ...
            className="bg-gray-800 text-white p-4 rounded-full shadow-lg hover:bg-gray-900 transition-all duration-300 transform hover:scale-110 group-hover:shadow-xl floating-contact-button"
            title="Back to Top"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
